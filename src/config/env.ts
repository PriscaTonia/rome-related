...
const development: Ienv = {
  ...
  GOOGLE_REDIRECT_URI: "http://localhost:2750/api/v1/auth/google",
...
const production: Ienv = {
  ...
  authCookieConfig: {
    httpOnly: true,
    domain: "rome-related.co.nz",
    secure: true,
    sameSite: "strict",
  },
  CLIENT_URL: "https://rome-related.co.nz",
  ADMIN_URL: "https://admin.rome-related.co.nz",
